...
public class AlignBackwardCommand extends Command {
    ...
    public AlignBackwardCommand (CommandSwerveDrivetrain swerve, GenericHID controller) {
        this.swerve = swerve;
    ...
    public boolean isFinished() {
        return Math.abs(pidController.getError()) < 0.5 || !controller.getRawButton(GamepadConstants.kAButtonPort);
    }
}
