...
public class HangLiftDownCommand extends Command{
    private HangSubsystem hangSubsystem;
    private GenericHID controller;

    public HangLiftDownCommand (HangSubsystem hangSubsystem, GenericHID controller) {
