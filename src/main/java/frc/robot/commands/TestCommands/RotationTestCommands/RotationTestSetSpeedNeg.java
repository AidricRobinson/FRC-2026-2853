...
public class RotationTestSetSpeedNeg extends Command {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private final RotationSubsystem rotationSubsystem;
  private GenericHID controller;

   
  public RotationTestSetSpeedNeg(RotationSubsystem rotationSubsystem, GenericHID m_controller) {
  ...
  public void initialize() {
    rotationSubsystem.setPower(-0.02);
}
