...
public class RotationBottomCommand extends Command {
    private RotationSubsystem m_RotationSubsystem;

    public RotationBottomCommand(RotationSubsystem rotationSubsystem){
    ...
    public void initialize(){
        m_RotationSubsystem.setPoint(RotationConstants.kRotationDownPosition);
    }
    @Override
    public void execute(){
